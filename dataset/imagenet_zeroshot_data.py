...
IMAGENET_CLASS = '''n02119789 1 kit_fox
...
IMAGENET_CLASS = {line.split(" ")[0]: line.split(" ")[1:] for line in IMAGENET_CLASS.strip().split("\n")}
IMAGENET_CLASS_NAME = [v[1] for k,v in IMAGENET_CLASS.items()]


DATASET_TO_CLASSNAME = dict(
